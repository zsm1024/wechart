...
<body class="easyui-layout">
	<div data-options="region:'north',title:'查询条件'" style="height: 113px">
		<form>
			<table class="queryTable" style="width: 100%">
				...
				<tr>
		            <td class="queryBtnTd" colspan="6">
		                <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="selectFBManager()">查询</a>
		                &nbsp;&nbsp;
